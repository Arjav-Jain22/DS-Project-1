...
**1. Clone the repo**
```bash
git clone https://github.com/Arjav-Jain22/DS-Project-1.git
cd DS-Project-1
```
...
**Arjav Jain**
B.Tech Computer Science with Artificial Intelligence & Data Science | Poornima University
[GitHub](https://github.com/Arjav-Jain22)